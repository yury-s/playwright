...
### param: ElementHandle.evalOnSelector.expression = %%-python-evaluate-expression-%%
### param: ElementHandle.evalOnSelectorAll.expression = %%-python-evaluate-expression-%%
### param: Frame.evalOnSelector.expression = %%-python-evaluate-expression-%%
### param: Frame.evalOnSelectorAll.expression = %%-python-evaluate-expression-%%
...
### param: Page.evalOnSelector.expression = %%-python-evaluate-expression-%%
### param: Page.evalOnSelectorAll.expression = %%-python-evaluate-expression-%%
...
### param: ElementHandle.evalOnSelector.expression = %%-python-evaluate-force-expression-%%
### param: ElementHandle.evalOnSelectorAll.expression = %%-python-evaluate-force-expression-%%
### param: Frame.evalOnSelector.expression = %%-python-evaluate-force-expression-%%
### param: Frame.evalOnSelectorAll.expression = %%-python-evaluate-force-expression-%%
...
### param: Page.evalOnSelector.expression = %%-python-evaluate-force-expression-%%
### param: Page.evalOnSelectorAll.expression = %%-python-evaluate-force-expression-%%
